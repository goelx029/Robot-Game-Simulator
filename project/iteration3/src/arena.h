...
class Arena {
 public:
   /**
    * @brief The constructor of the arena.
    *
    * @param[in] an arena_params struct object that contains data
    * about initializing the arena.
    */
  ...
  */
  ...
  /**
   * @brief Reset all entities in the arena
   */
  void Reset(void);
  ...
  /**
   * @brief functions that returns the player entity of the arena.
   */
  Player* player(void) const { return player_; }
  /**
   * @brief functions that returns the robot entity of the arena.
   */
  Robot* robot(void) const { return robot_; }
  /**
   * @brief functions that returns the superbot entity of the arena.
   */
  SuperBot* superbot(void) const { return superbot_; }
  /**
   * @brief functions that returns the home_base entity of the arena.
   */
  HomeBase* home_base(void) const { return home_base_; }
  /**
   * @brief functions that returns the recharge_station entity of the arena.
   */
  RechargeStation* recharge_station(void) const { return recharge_station_; }

  /**
   * @brief functions that return the status of the game (whether win or not).
   */
  bool get_win_status(void) { return win; }
  /**
   * @brief functions that return the status of the game (whether lost or not).
   */
  bool get_lose_status(void) { return lost; }
 ...
 private:
  ...
  double x_dim_;
  double y_dim_;
  // boolean variables that save the state of the game (Win or Lost).
  bool lost;
  bool win;
