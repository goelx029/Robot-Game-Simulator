 ...
 ******************************************************************************/
 /**
 * @brief A class that inherits from the EventBaseClass and handles all the Keypress
 * events in the arena because of the user activity. This class is responsible to
 * handle arrowkeypress by user to result in speed change or rotation of robot.
 *
 */
